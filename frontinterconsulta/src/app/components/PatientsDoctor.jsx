        ...
        getPatients.data.length > 0 ? (
          <div className='flex justify-center items-center flex-col gap-3'>
            <Autocomplete
              ...
              options={getPatients.data.map((data) => data.Solicitante)}
                ...
                <div key={index} onClick={() => alert('Ola Paciente')}
                  ...
                  <div className="sm:flex sm:justify-center mb-4">
                    {paciente.FotoPaciente ? 
                      <Image src={`${config.apiBaseUrl}/${paciente.Foto}`} alt={`Foto do Paciente ${paciente.Solicitante}`} width={100} height={100} className="sm:rounded-full rounded-xl" /> 
                      : 
